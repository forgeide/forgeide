...
insert into TemplateService (id, PROJECT_TEMPLATE_ID, code, name, description, forgeCommand, steps) values (2, 1, 'rest', 'REST', 'Enables REST services for your project.', 'REST: Setup', 1);
